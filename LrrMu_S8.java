...
/**
 * Laboratoire 2 - Partie 4 : variante de LrrMu pour le scenario 8.
 *
 ...
 */
public class LrrMu_S8 {

    public static void main(String[] args) throws IOException {
        boolean enableOutput = true;
        boolean outputToFile = false;
        String inputFolder = LrrMu_S8.class.getClassLoader().getResource("workload/planetlab").getPath();
