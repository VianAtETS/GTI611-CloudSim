...
Welcome to the **GTI611-CloudSim** repository! This repository was generated from a template to get you started quickly.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/VianAtETS/GTI611-CloudSim.git
   cd GTI611-CloudSim
   ```
