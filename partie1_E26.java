...
public class partie1_E26 {
    // la liste de cloudlets
    private static List<Cloudlet> cloudletList;

    /** The vmlists. */
    private static List<Vm> vmlist;
    private static int NbCloudlets =10;
    public static void main(String[] args) {
        Log.printLine("Starting partie1_E26..");
        try {
            ...
            //Étape 3: Création des brokers (un broker par client cloud)
    ...
    private static Datacenter createDatacenter(String name){
        ...
        for(int hostId=1;hostId<4;hostId++){
            hostList.add(
                    new Host(
                            hostId,
