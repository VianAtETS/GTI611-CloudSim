...
/**
 * Laboratoire 2 - Partie 4 : variante de LrrMmt pour le scenario 9.
 *
 ...
 */
public class LrrMmt_S9 {

    public static void main(String[] args) throws IOException {
        boolean enableOutput = true;
        boolean outputToFile = false;
        String inputFolder = LrrMmt_S9.class.getClassLoader().getResource("workload/planetlab").getPath();
